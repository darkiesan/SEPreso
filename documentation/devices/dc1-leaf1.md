...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_SERVER_GW1_Eth0 | *access | *100 | *- | *- | 1 |
| Ethernet2 | SERVER_SERVER1-1_Eth0 | *access | *10 | *- | *- | 2 |
| Ethernet11 | MLAG_dc1-leaf2_Ethernet11 | *trunk | *- | *- | *MLAG | 11 |
| Ethernet12 | MLAG_dc1-leaf2_Ethernet12 | *trunk | *- | *- | *MLAG | 11 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet7 | P2P_dc2-leaf1_Ethernet7 | - | 10.0.0.0/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_dc2-leaf2_Ethernet8 | - | 10.0.0.2/31 | default | 1500 | False | - | - |
| Ethernet9 | P2P_dc1-spine1_Ethernet1 | - | 10.1.2.1/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_dc1-spine2_Ethernet1 | - | 10.1.2.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_SERVER_GW1_Eth0
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_SERVER1-1_Eth0
   no shutdown
   channel-group 2 mode active
!
interface Ethernet7
   description P2P_dc2-leaf1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_dc2-leaf2_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet11
   description MLAG_dc1-leaf2_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_dc1-leaf2_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_dc1-leaf2_Port-Channel11 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_dc1-leaf2_Port-Channel11
   no shutdown
...
| 3 | 10.1.0.3:10003 | 65000:10003 | - | - | learned |
| 5 | 10.1.0.3:10005 | 65000:10005 | - | - | learned |
...
router bgp 65101
   ...
   neighbor 10.1.4.1 description dc1-leaf2_Vlan4093
   ...
   vrf FW_TEST1
      ...
      router-id 10.1.0.3
      neighbor 10.1.4.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.1.4.1 description dc1-leaf2_Vlan3000
