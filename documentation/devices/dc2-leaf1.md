...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_GW2_Eth0 | *access | *100 | *- | *- | 1 |
| Ethernet2 | SERVER2-1_Eth0 | *access | *10 | *- | *- | 2 |
| Ethernet11 | MLAG_PEER_dc2-leaf2_Ethernet11 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_dc2-leaf2_Ethernet12 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet7 | P2P_LINK_TO_dc1-leaf1_Ethernet7 | routed | - | 10.0.0.1/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_dc1-leaf2_Ethernet8 | routed | - | 10.0.0.7/31 | default | 1500 | False | - | - |
| Ethernet9 | P2P_LINK_TO_DC2-SPINE1_Ethernet1 | routed | - | 10.2.2.1/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_LINK_TO_DC2-SPINE2_Ethernet1 | routed | - | 10.2.2.3/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_GW2_Eth0
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER2-1_Eth0
   no shutdown
   channel-group 2 mode active
!
interface Ethernet7
   description P2P_LINK_TO_dc1-leaf1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_dc1-leaf2_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet11
   description MLAG_PEER_dc2-leaf2_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_dc2-leaf2_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_dc2-leaf2_Po11 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_dc2-leaf2_Po11
   no shutdown
   switchport
...
router bgp 65201
   ...
   neighbor 10.2.4.1 description dc2-leaf2
