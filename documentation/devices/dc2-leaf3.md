...
| --------- | --------------- | ------------ | --------- |
| dc2-leaf-pair2 | Vlan4094 | 10.2.3.5 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_SERVER2-2_Eth0 | *access | *10 | *- | *- | 1 |
| Ethernet11 | MLAG_dc2-leaf4_Ethernet11 | *trunk | *- | *- | *MLAG | 11 |
| Ethernet12 | MLAG_dc2-leaf4_Ethernet12 | *trunk | *- | *- | *MLAG | 11 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet9 | P2P_dc2-spine1_Ethernet3 | - | 10.2.2.9/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_dc2-spine2_Ethernet3 | - | 10.2.2.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_SERVER2-2_Eth0
   no shutdown
...
interface Ethernet11
   description MLAG_dc2-leaf4_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_dc2-leaf4_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SERVER2-2 | access | 10 | - | - | - | - | 1 | - |
| Port-Channel11 | MLAG_dc2-leaf4_Port-Channel11 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel11
   description MLAG_dc2-leaf4_Port-Channel11
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.2.0.5/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.2.1.5/32 |
| Loopback3 | IGMP snooping querier | FW_TEST1 | 10.255.0.5/32 |
...
| Vlan3000 |  FW_TEST1  |  10.2.4.4/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.2.4.4/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.2.3.4/31  |  -  |  -  |  -  |  -  |
...
| 10.2.2.8 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.2.2.10 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.2.4.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.2.4.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | FW_TEST1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65202
   ...
   neighbor 10.2.2.8 remote-as 65200
   neighbor 10.2.2.8 description dc2-spine1_Ethernet3
   neighbor 10.2.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.2.10 remote-as 65200
   neighbor 10.2.2.10 description dc2-spine2_Ethernet3
   neighbor 10.2.4.5 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.2.4.5 description dc2-leaf4_Vlan4093
   ...
   vrf FW_TEST1
      ...
      router-id 10.2.0.5
      neighbor 10.2.4.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.2.4.5 description dc2-leaf4_Vlan3000
...
ip igmp snooping vlan 10 querier address 10.2.0.5
ip igmp snooping vlan 10 querier version 3
ip igmp snooping vlan 100 querier
ip igmp snooping vlan 100 querier address 10.2.0.5
...
```eos
!
ip address virtual source-nat vrf FW_TEST1 address 10.255.0.5
```
