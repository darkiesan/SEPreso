...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER2-2_Eth0 | *access | *10 | *- | *- | 1 |
| Ethernet11 | MLAG_PEER_dc2-leaf4_Ethernet11 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_dc2-leaf4_Ethernet12 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet9 | P2P_LINK_TO_DC2-SPINE1_Ethernet3 | routed | - | 10.2.2.9/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_LINK_TO_DC2-SPINE2_Ethernet3 | routed | - | 10.2.2.11/31 | default | 1500 | False | - | - |
...
interface Ethernet11
   description MLAG_PEER_dc2-leaf4_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_dc2-leaf4_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_dc2-leaf4_Po11 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_dc2-leaf4_Po11
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.0.5/32 |
...
router bgp 65202
   ...
   neighbor 10.2.4.5 description dc2-leaf4
