...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet9 | P2P_dc1-spine1_Ethernet3 | - | 10.1.2.9/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_dc1-spine2_Ethernet3 | - | 10.1.2.11/31 | default | 1500 | False | - | - |
...
| Port-Channel11 | MLAG_dc1-leaf4_Port-Channel11 | trunk | - | - | MLAG | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.5/32 |
...
| 5 | 10.1.0.5:10005 | 65000:10005 | - | - | learned |
...
router bgp 65102
   ...
   neighbor 10.1.4.5 description dc1-leaf4_Vlan4093
   ...
   vrf FW_TEST1
      ...
      router-id 10.1.0.5
      neighbor 10.1.4.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.1.4.5 description dc1-leaf4_Vlan3000
