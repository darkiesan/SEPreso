...
| --------- | --------------- | ------------ | --------- |
| dc1-leaf-pair2 | Vlan4094 | 10.1.3.5 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER1-2_Eth0 | *access | *10 | *- | *- | 1 |
| Ethernet11 | MLAG_PEER_dc1-leaf4_Ethernet11 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_dc1-leaf4_Ethernet12 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet9 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 10.1.2.9/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | routed | - | 10.1.2.11/31 | default | 1500 | False | - | - |
...
interface Ethernet11
   description MLAG_PEER_dc1-leaf4_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_dc1-leaf4_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | SERVER1-2_SERVER1-2 | switched | access | 10 | - | - | - | - | 1 | - |
| Port-Channel11 | MLAG_PEER_dc1-leaf4_Po11 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description SERVER1-2_SERVER1-2
   no shutdown
   switchport
...
interface Port-Channel11
   description MLAG_PEER_dc1-leaf4_Po11
   no shutdown
   switchport
...
| Vlan3000 |  FW_TEST1  |  10.1.4.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.1.4.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.1.3.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.1.2.8 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.1.2.10 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.1.4.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.1.4.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | FW_TEST1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor 10.1.2.8 remote-as 65100
   neighbor 10.1.2.8 description dc1-spine1_Ethernet3
   neighbor 10.1.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.1.2.10 remote-as 65100
   neighbor 10.1.2.10 description dc1-spine2_Ethernet3
   neighbor 10.1.4.5 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.1.4.5 description dc1-leaf4
...
ip igmp snooping vlan 10 querier address 10.1.0.5
ip igmp snooping vlan 10 querier version 3
ip igmp snooping vlan 100 querier
ip igmp snooping vlan 100 querier address 10.1.0.5
