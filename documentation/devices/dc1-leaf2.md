...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_GW1_Eth1 | *access | *100 | *- | *- | 1 |
| Ethernet2 | SERVER1-1_Eth1 | *access | *10 | *- | *- | 2 |
| Ethernet11 | MLAG_PEER_dc1-leaf1_Ethernet11 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_dc1-leaf1_Ethernet12 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet7 | P2P_LINK_TO_dc2-leaf2_Ethernet7 | routed | - | 10.0.0.4/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_dc2-leaf1_Ethernet8 | routed | - | 10.0.0.6/31 | default | 1500 | False | - | - |
| Ethernet9 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 10.1.2.5/31 | default | 1500 | False | - | - |
| Ethernet10 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 10.1.2.7/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description SERVER_GW1_Eth1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER1-1_Eth1
   no shutdown
   channel-group 2 mode active
!
interface Ethernet7
   description P2P_LINK_TO_dc2-leaf2_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_dc2-leaf1_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet11
   description MLAG_PEER_dc1-leaf1_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_dc1-leaf1_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| Port-Channel11 | MLAG_PEER_dc1-leaf1_Po11 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_dc1-leaf1_Po11
   no shutdown
   switchport
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.0.5 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | False | - | - | - | - |
| 10.0.0.7 | 65201 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | False | - | - | - | - |
...
| 10.1.2.4 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.1.2.6 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.1.4.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.1.4.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | FW_TEST1 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 2 | 10.1.0.4:10002 | 65000:10002 | - | - | learned |
...
router bgp 65101
   ...
   neighbor 10.1.4.0 description dc1-leaf1
